...
public class DataEntryController {
    ...
    public void switchToReviewScreen(ActionEvent actionEvent) throws IOException {
        ...
        ReviewController reviewController = loader.getController();
        reviewController.setCitizenName(citizenNameField.getText());
        reviewController.setCitizenID(citizenIDField.getText());
        reviewController.setImmigrantID(immigrantIDField.getText());
        reviewController.setImmigrantName(immigrantNameField.getText());
        reviewController.setFormID(formIDField.getText());
        reviewController.setFormDescription(formDescriptionField.getText());
